...
object DiagnosticReport {
    fun create(
        ...
        appendLine("Pointer input rate: ${hidState.pointerInputRateHz} Hz")
        appendLine("Pointer output rate: ${hidState.pointerOutputRateHz} Hz")
        appendLine("Pointer rejected reports: ${hidState.pointerRejectedReports}")
        appendLine("Pointer pending reports: ${hidState.pointerPendingReports}")
        appendLine()
